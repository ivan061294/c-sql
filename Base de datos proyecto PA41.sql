...
go
create table marca (idmarca int identity(1,1)primary key,nombre varchar(39),modelo varchar(30))
go
...
insert into marca values('samsung','smart')
...
insert into producto values ('EOS 70WD17',25,15,2,1499)
insert into producto values ('ILCE-6000L',50,16,2,1899)
insert into producto values ('DSC-RX100',65,17,2,1299)
insert into producto values ('FDR-AX40',65,18,2,2799)
insert into producto values ('HDR-Cx675',45,19,2,2449)
insert into producto values ('DSC-HX400V',65,20,2,1199)

insert into producto values ('P30 Lite',30,21,3,1599)
insert into producto values ('Iphone 7 Jet Black',40,22,3,2199)
insert into producto values ('Iphone 7',50,23,3,2499)
insert into producto values ('Iphone 7 Plus',60,24,3,2699)
insert into producto values ('Iphone 8',35,25,3,2899)
insert into producto values ('iPhone XR',45,26,3,3599)
insert into producto values ('Iphone 11',55,27,3,4149)
insert into producto values ('P30 pro',65,28,3,3999)
insert into producto values ('Galaxy Note',35,29,3,4499)
insert into producto values ('Y9 2019',45,30,3,749)

insert into producto values ('Laptop Pavilion',30,31,4,2649)
insert into producto values ('MacBook',40,32,4,4199)
insert into producto values ('Notebook Pavilion',50,33,4,3499)
insert into producto values ('iMac',60,34,4,4799)
insert into producto values ('Laptop Gamer Omen 15.6',25,35,4,3699)
insert into producto values ('Laptop Spin3',35,36,4,1999)
insert into producto values ('iMac 27',45,37,4,10199)
insert into producto values ('Laptip Gamer Omen 15.6',65,38,4,4399)
insert into producto values ('AIO 23.8P ci3',45,39,4,2699)
insert into producto values ('AIO 23.8P ci5',35,40,4,3499)
...
select * from venta
select * from detalle_VentProd
select idprod as 'codigo',nombre as 'nombre',stock as 'stock',precio as 'precio' from producto where nombre like '%life%'